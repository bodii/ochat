...
type User struct {
	...
	Nickname       string    `xorm:"varchar(20) not null default '' comment('用户昵称')" form:"nickname" json:"nickname"`
	NicknamePrefix string    `xorm:"varchar(2) not null default '' comment('用户昵称前缀(e.g 刘:L)')" form:"nickname_prefix" json:"nickname_prefix"`
